...
\newcommand{\fixed}{\textcolor{purple}{ \Large \underline{\textbf{Fixed}} }}
\newcommand{\reply}{\textcolor{blue}{ \large \textbf{Reply will be written} }}
\newcommand{\written}{ \textcolor{purple}{\large Reply is written}}
...
\textcolor{darkgreen}{AZ: The argument is dropped; commented out in the latex file 'paper.tex' line 860}
...
\textcolor{blue}{AZ: We already mentioned and gave references demonstrating the effectiveness and flexibility of GANs. As they are becoming very common method in data augmentation, we have investigated its power to solve the problem at hand. Furthermore, our study was not comparative in nature with regards to data augmentation methods. \\
