...
\begin{figure*}
	...
	\begin{subfigure}{\textwidth}
		...
		\addlegendimage{first}\addlegendentry{\cite{paper0} MSE: 0.09}
		\addlegendimage{second}\addlegendentry{Proposed MSE: 0.19 }
		...
		\addlegendimage{first}\addlegendentry{\cite{paper0} MSE:0.17}
		\addlegendimage{second}\addlegendentry{Proposed MSE:0.37 }
	
		\end{axis}
		\end{tikzpicture}
		\captionsetup{justification=centering}
		\caption{Configuration estimation on SPR dataset. \hl{Left: $ n_{analyte} = 1.34 $ $ n_{eff} = 1.46$ $ \Lambda = 0.24 \mu m$ $ d_1 = 0.45 \mu m $ $ d_2= 0.75 \mu m$ $ d_3 = 0.35 \mu m $.} \hl{Right: $ n_{analyte} = 1.35 $	$ n_{eff} = 1.45 $ $ \Lambda = 0.15 \mu m $ $ d_1 = 0.25 \mu m $ $ d_2= 0.75 \mu m $ $ d_3 = 0.35 \mu m  $.}		
		  }
	\end{subfigure}
...
\begin{figure*}
	...
	\begin{subfigure}{\textwidth}
		...
		\addlegendimage{first}\addlegendentry{Without GAN:0.19}
		\addlegendimage{second}\addlegendentry{With GAN:0.12 }
