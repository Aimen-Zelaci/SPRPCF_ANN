...
\begin{figure*}
	...
	\begin{subfigure}{\textwidth}
		...
		\\\hl{$ n_{analyte} = 1.34 $ $ n_{eff} = 1.46$ $ \Lambda = 0.24 $ $ d1 = 0.45 um $ $ d2= 0.75 um$ $ d3 = 0.35 um $.}\\ \hl{ $ n_{analyte} = 1.35 $	$ n_{eff} = 1.45 $ $ \Lambda = 0.15 um $ $ d1 = 0.25 um $ $ d2= 0.75um $ $ d3 = 0.35um $.}		
		  }
	\end{subfigure}
...
\begin{figure*}
	...
	\begin{subfigure}{\textwidth}
		...
		\captionsetup{justification=centering}
		\caption{Configuration estimation on SPR dataset. 
		\\ \hl{$n_{analyte} = 1.34$ $ n_{eff} = 1.46 $ $ \Lambda = 0.24 um $ $ d1 = 0.45 um $ $ d2= 0.75um $ $ d3 = 0.35um $.} \\ \hl{$n_{analyte} = 1.33 $ $ n_{eff} = 1.45 $ $ \Lambda = 0.15 um $ $ d1 = 0.25 um $ $ d2= 0.55um $ $ d3 = 0.15um $.} 
		}
	\end{subfigure}
