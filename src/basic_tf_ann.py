...
# Network Parameters
n_hidden = FLAGS.num_neurons
n_input = FLAGS.num_inputs
n_outputs = FLAGS.num_outputs
...
def train():
    ...
    for epoch in range(training_epochs):
        ...
        print('tr_loss at EPOCH {} is {:.6f} \t\t va_MSE is {:.6f} \t\t {:.6f} sec'.format(epoch + 1, cost, va_mse,
